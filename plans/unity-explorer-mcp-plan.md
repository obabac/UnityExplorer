...
- Attempted Unity GUI Player settings on the Test-VM to switch the Standalone target to Mono/x86_64; navigation remains incomplete, so the Mono build is still pending.
